...
class ConfigListener
{
    ...
    public function defaults(\SymBB\Core\SystemBundle\Event\ConfigDefaultsEvent $event)
    {
        ...
        $terms = "By accessing “symBB.de” (hereinafter “we”, “us”, “our”, “symBB.de”, “https://www.symBB.de”), you agree to be legally bound by the following terms. 
            If you do not agree to be legally bound by all of the following terms then please do not access and/or use “symBB.de”. 
            We may change these at any time and we’ll do our utmost in informing you, though it would be prudent to review this regularly yourself as your continued usage of “symBB.de” after changes mean you agree to be legally bound by these terms as they are updated and/or amended.
            Our forums are powered by symBB (hereinafter “they”, “them”, “their”, “symBB software”, “www.symBB.de”, “Christian Wielath”, “symBB Teams”) which is a bulletin board solution released under the “General Public License” (hereinafter “GPL”) and can be downloaded from www.symBB.de. The symBB software only facilitates internet based discussions, the symBB Group are not responsible for what we allow and/or disallow as permissible content and/or conduct. For further information about symBB, please see: https://www.symBB.de/.
