...
class FrontendPostController extends \SymBB\Core\SystemBundle\Controller\AbstractController
{
    ...
    protected function getPostForm($topic, &$post)
    {
        ...
        $formType = new \SymBB\Core\ForumBundle\Form\Type\PostType($url, $post, $dispatcher, $this->get('translator'), $this->get('doctrine.orm.symbb_entity_manager'), $this->get('symbb.core.user.manager'), $this->get('symbb.core.group.manager'));
