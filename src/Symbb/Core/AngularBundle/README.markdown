# SymbbCoreAngularBundle

This bundle has some Utilsstuff for the Angular Forntend.
Angular2Twig Template converter, Routing export etc...
The Template developer can use it but its optional. ( e.g if they dont want to use angular )

I Think later it should be completly in the Template Bundle and not a standalone Bundle.
