...
!function (a) {
    a.Editable.commands = a.extend(a.Editable.commands, {
        ...
        this.closeImageMode(), this.imageMode = !1, this.showFileUpload(), this.saveSelectionByMarkers(), this.options.inlineMode || this.positionPopup("uploadFile")
        ...
        b.$file_wrapper.on("dragover", "#f-file-upload-div-" + this._id, function () {
            ...
            c.preventDefault(), c.stopPropagation(), a(this).removeClass("f-hover"), b.uploadFile(c.originalEvent.dataTransfer.files)
        })
    }, a.Editable.prototype.buildFileUpload = function () {
        this.$file_wrapper = a(this.fileUploadHTML()), this.$popup_editor.append(this.$file_wrapper), this.buildFileDrag();
        var b = this;
        ...
        this.$file_wrapper.on("change", 'input[type="file"]', function () {
            ...
            a(this).val("")
        }), this.$file_wrapper.on(this.mouseup, "#f-file-close-" + this._id, a.proxy(function () {
            e.stopPropagation(), e.preventDefault(), this.$bttn_wrapper.show(), this.hideFileWrapper(), this.restoreSelection(), this.focus(), this.hide()
        ...
        if (void 0 !== b && b.length > 0) {
            ...
            if (c) {
                var e;
                if (this.options.crossDomain)e = this.createCORSRequest("POST", this.options.fileUploadURL); else {
                    e = new XMLHttpRequest, e.open("POST", this.options.fileUploadURL);
        ...
        this.triggerEvent("fileError", [{message: a, code: 0}], !1), this.hideFileLoader()
        ...
        this.restoreSelectionByMarkers(), this.focus(), this.insertHTML('<a class="fr-file" href="' + this.sanitizeURL(a) + '">' + b + "</a>"), this.hide(), this.hideFileLoader(), this.focus(), this.triggerEvent("fileUploaded", [b, a])
    }
}(jQuery);